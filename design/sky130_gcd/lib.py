...
def config(max_fanout,is_max_length_opt,max_length_constraint,is_timing_effort,ignore_net_degree,num_threads,init_wirelength_coef,
    ...
    change_config_pl('        \"is_timing_effort\": ',is_timing_effort,f'{config_dir}/pl_default_config.json')
